/*
 * Original version found in NPM package "node-osc". Stripped out
 * Client code since it caused problems with Windows and we only
 * required the Server code.
 *
 * Credit goes to: https://github.com/TheAlphaNerd/node-osc
 *
 */
